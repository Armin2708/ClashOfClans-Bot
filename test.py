...
def test_buttons():
    ...
    print("Make sure you're on the VILLAGE screen")
    from screen import screenshot
    from vision import find_button, detect_screen_state
    img = screenshot()
...
def test_roi_speed():
    ...
    from screen import screenshot
    from vision import detect_screen_state, _find_in_roi, _get_template_gray, get_template
...
def test_troop_slots():
    ...
    from screen import screenshot
    from vision import get_troop_slots
    from utils import save_debug
    img = screenshot()
...
def test_surrender():
    ...
    print("Starting in 5 seconds... (Ctrl+C to cancel)")
    time.sleep(5)
    from battle import surrender_and_return
