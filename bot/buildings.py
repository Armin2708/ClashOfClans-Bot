...
from bot.screen import screenshot, tap
from bot.vision import find_button, detect_walls, read_resources_from_village
from bot.utils import find_template, save_debug, load_template
