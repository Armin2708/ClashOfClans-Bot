...
HV_DEFENSES: dict[str, int] = {
    ...
    "x_bow":                12,
    "inferno_tower":        11,
    "eagle_artillery":       6,   # legacy — merged into inferno_artillery in TH17+
    ...
    "monolith":              4,   # TH15+
    "ricochet_cannon":       3,   # TH16+
    "multi_archer_tower":    3,   # TH16+ (merged from geared-up Archer Tower)
    "spell_tower":           3,   # TH15+
    "firespitter":           2,   # TH17+
    "multi_gear_tower":      2,   # TH16+
...
HV_SPECIAL: dict[str, int] = {
    ...
    "builder_hut":           5,
    "chiefs_helper_hut":     1,
    "wall":                 18,   # Wall segments (level = visual tier)
}
