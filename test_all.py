...
def test_state_tracker_init():
    ...
    from state_machine import GameState, StateTracker
...
def test_valid_transitions():
    ...
    from state_machine import GameState, VALID_TRANSITIONS
...
def test_state_timeouts():
    ...
    from state_machine import GameState, STATE_TIMEOUTS
...
def test_building_dataclass():
    ...
    from buildings import Building, GOLD_WALL
...
def test_building_templates():
    ...
    from buildings import GOLD_WALL
...
def test_wall_strategy_should_upgrade():
    ...
    from config import GOLD_STORAGE_FULL, ELIXIR_STORAGE_FULL
...
def test_upgrade_strategy_abc():
    ...
    from buildings import UpgradeStrategy
...
def test_adb_connection():
    print("\n>>> TEST: ADB connection")
    from screen import check_adb_connection
...
def test_wait_for_state():
    ...
    from screen import wait_for_state
    from vision import detect_screen_state
    from screen import screenshot
...
def test_tap_and_verify():
    ...
    from screen import tap_and_verify
...
def test_button_detection():
    ...
    from screen import screenshot
    from vision import find_button
...
def test_ensure_on_village_mocked():
    ...
    with patch("main.screenshot", return_value=dummy_img), \
         patch("main.detect_screen_state", return_value=GameState.VILLAGE), \
         patch("main.find_popup", return_value=None), \
         patch("main.tap"):
        from main import ensure_on_village, state_tracker
...
def test_main_loop_stops_on_upgrade_fail():
    ...
    from config import GOLD_STORAGE_FULL
    ...
    from main import UPGRADE_STRATEGIES
