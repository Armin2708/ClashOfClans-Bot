...
def main():
    os.makedirs("data/templates/buttons", exist_ok=True)
    os.makedirs("data/templates/popups", exist_ok=True)
    ...
    if img is not None:
        ...
        crop_and_save(img, 10, 1260, 200, 1430,
                      "data/templates/buttons/attack_button.png", "(Attack!)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 145, 1070, 735, 1160,
                      "data/templates/buttons/find_match.png", "(Find a Match)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 2015, 1230, 2510, 1340,
                      "data/templates/buttons/start_battle.png", "(Army Attack!)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 2250, 1020, 2490, 1160,
                      "data/templates/buttons/next_base.png", "(Next 1700)")
        # End Battle: red button bottom-left
        crop_and_save(img, 30, 1075, 340, 1130,
                      "data/templates/buttons/end_battle.png", "(End Battle)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 1100, 1158, 1462, 1318,
                      "data/templates/buttons/return_home.png", "(Return Home)")
        crop_and_save(img, 880, 250, 1680, 600,
                      "data/templates/buttons/stars_screen.png", "(Victory/Stars)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 1540, 1110, 1800, 1400,
                      "data/templates/buttons/upgrade_wall.png", "(Upgrade gold)")
        # 6th button (elixir Upgrade): x:1850-2080
        crop_and_save(img, 1840, 1110, 2100, 1400,
                      "data/templates/buttons/upgrade_wall_elixir.png", "(Upgrade elixir)")
    else:
        print("  NOT FOUND")
    ...
    if img is not None:
        ...
        crop_and_save(img, 1450, 1220, 2000, 1340,
                      "data/templates/buttons/confirm_upgrade.png", "(Confirm)")
        ...
        crop_and_save(img, 2130, 40, 2230, 150,
                      "data/templates/popups/close_x.png", "(X close)")
    else:
        print("  NOT FOUND")
